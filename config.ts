...
export const AI_NAME = "your slave";
export const OWNER_NAME = "Shivangi Bansal";

export const WELCOME_MESSAGE = `Hello! I'm ${AI_NAME}, an assistant created by ${OWNER_NAME}.`
